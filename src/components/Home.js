  ...
  return (
    <div className="container mt-5">
      <div className="card p-4 shadow">
        ...
        <ol className="mb-4">
          <li>Upload Books: Click the "Upload Books" button to upload books.</li>
          <li>Start MapReduce: Click the "Start MapReduce" button to initiate the map-reduce process.</li>
          <li>Search Words: Use the search bar below to search for words in the books.</li>
        </ol>
